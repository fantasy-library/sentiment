...
def display_methodology_notes(config):
    ...
    print(f"   • Material type: {config.material_type}")
    print(f"   • Sentiment thresholds: +{config.POSITIVE_THRESHOLD} / {config.NEGATIVE_THRESHOLD}")
    print(f"   • Context window: {config.CONTEXT_WINDOW} words")
    print(f"   • N-gram analysis: {config.NGRAM_SIZE}-grams")

    print(f"\n⚡ Enhanced Features:")
    print(f"   ✅ Auto-detection of material type")
    print(f"   ✅ Negation handling in sentiment calculation")
    print(f"   ✅ Enhanced context analysis")
    print(f"   ✅ Thematic sentiment mapping")
    print(f"   ✅ Sentiment trend analysis")
    print(f"   ✅ Reading difficulty assessment")

    print(f"\n⚠️ Important Limitations:")
    print(f"   • VADER works best with informal text; formal academic writing may need domain-specific models")
    print(f"   • Sarcasm, irony, and cultural nuances may not be fully captured")
    print(f"   • Context-dependent meanings (domain-specific jargon) may be misinterpreted")
    print(f"   • Results should be validated with manual analysis for critical applications")

    print(f"\n📋 Recommendations:")
    print(f"   • Use results as a starting point for deeper qualitative analysis")
    print(f"   • Adjust thresholds and themes based on your specific domain")
    print(f"   • Cross-validate findings with subject matter experts")
    print(f"   • Consider cultural and temporal context of the text")
