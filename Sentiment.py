...
def main():
    ...
    st.markdown("**Sentiment analysis for any text: novels, articles, reviews, news, social media, academic papers, interviews, and more**")
...
def run_sentiment_analysis(raw_text, material_type):
    ...
    try:
        ...
        st.warning(f"⚠️ Analysis failed, using simplified mode: {str(e)}")
...
def display_streamlit_results(results_data, config, raw_text):
    ...
    st.info("⚠️ **For reference only** - These results are generated by automated analysis and should not be considered definitive.")
    ...
    st.warning("📋 **For reference only** - These insights are based on automated analysis and should be used as a starting point for further research.")
    ...
    with st.expander("⚠️ Methodology & Limitations - Click to expand"):
        st.info("🔍 **For reference only** - This analysis uses automated sentiment analysis tools and should be interpreted with caution.")
    ...
    with col2:
        ...
        <div style='text-align: center; color: #666; font-size: 12px;'>
            <p><strong>Sentiment Analysis Tool v1.0-beta</strong></p>
...
def display_methodology_notes(config):
    ...
    **Text Processing:**
    ...
    st.write("✅ Context analysis with surrounding words")
